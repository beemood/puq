...
AccessToken: z.boolean()
      ...
      export const AccessTokenOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
userId: z.boolean(),
user: z.boolean(),
AccessTokenPermission: z.boolean()
      ...
      export const ScopeOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
permissions: z.boolean()
      }).partial()
      ...
      export const ResourceOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
activities: z.boolean()
      ...
      export const OperationOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
activities: z.boolean()
      }).partial()
      ...
      export const ActivityOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
...
logs: z.boolean()
      ...
      export const PermissionOwnProjectionSchema = z.object({ 
          id: z.boolean(),
scopeId: z.boolean(),
...
AccessTokenPermission: z.boolean()
      ...
      export const RoleOwnProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
permissions: z.boolean()
      }).partial()
      ...
      export const RolePermissionOwnProjectionSchema = z.object({ 
          id: z.boolean(),
roleId: z.boolean(),
...
permission: z.boolean()
      ...
      export const SessionOwnProjectionSchema = z.object({ 
          id: z.boolean(),
userId: z.boolean(),
...
logs: z.boolean()
      ...
      export const ActivityLogOwnProjectionSchema = z.object({ 
          id: z.boolean(),
sessionId: z.boolean(),
activityId: z.boolean(),
createdAt: z.boolean(),
...
session: z.boolean()
      ...
      export const UserPermissionOwnProjectionSchema = z.object({ 
          id: z.boolean(),
userId: z.boolean(),
permissionId: z.boolean(),
user: z.boolean(),
permission: z.boolean()
      ...
      export const AccessTokenPermissionOwnProjectionSchema = z.object({ 
          id: z.boolean(),
permissionId: z.boolean(),
...
AccessTokenPermission: z.object({ 
    ...
    export const AccessTokenProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
userId: z.boolean(),
...
AccessTokenPermission: AccessTokenPermissionOwnQuerySchema
    ...
    export const AccessTokenQueryOneSchema = z.object({ 
...
permissions: z.object({ 
    ...
    export const ScopeProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
permissions: PermissionOwnQuerySchema
    ...
    export const ScopeQueryOneSchema = z.object({ 
...
activities: ActivityOwnQuerySchema
    ...
    export const ResourceQueryOneSchema = z.object({ 
...
activities: ActivityOwnQuerySchema
    ...
    export const OperationQueryOneSchema = z.object({ 
...
logs: ActivityLogOwnQuerySchema
    ...
    export const ActivityQueryOneSchema = z.object({ 
...
AccessTokenPermission: z.object({ 
    ...
    export const PermissionProjectionSchema = z.object({ 
          id: z.boolean(),
scopeId: z.boolean(),
activityId: z.boolean(),
...
AccessTokenPermission: AccessTokenPermissionOwnQuerySchema
    ...
    export const PermissionQueryOneSchema = z.object({ 
...
permissions: z.object({ 
    ...
    export const RoleProjectionSchema = z.object({ 
          id: z.boolean(),
name: z.boolean(),
permissions: RolePermissionOwnQuerySchema
    ...
    export const RoleQueryOneSchema = z.object({ 
...
permission: z.object({ 
    ...
    export const RolePermissionProjectionSchema = z.object({ 
          id: z.boolean(),
roleId: z.boolean(),
permissionId: z.boolean(),
...
permission: PermissionOwnQueryOneSchema
    ...
    export const RolePermissionQueryOneSchema = z.object({ 
...
logs: ActivityLogOwnQuerySchema
    ...
    export const SessionQueryOneSchema = z.object({ 
...
session: z.object({ 
    ...
    export const ActivityLogProjectionSchema = z.object({ 
          id: z.boolean(),
sessionId: z.boolean(),
activityId: z.boolean(),
createdAt: z.boolean(),
...
session: SessionOwnQueryOneSchema
    ...
    export const ActivityLogQueryOneSchema = z.object({ 
...
permission: z.object({ 
    ...
    export const UserPermissionProjectionSchema = z.object({ 
          id: z.boolean(),
userId: z.boolean(),
permissionId: z.boolean(),
user: UserOwnQueryOneSchema,
permission: PermissionOwnQueryOneSchema
    ...
    export const UserPermissionQueryOneSchema = z.object({ 
...
accessToken: z.object({ 
    ...
    export const AccessTokenPermissionProjectionSchema = z.object({ 
          id: z.boolean(),
permissionId: z.boolean(),
accessTokenId: z.boolean(),
permission: PermissionOwnQueryOneSchema,
accessToken: AccessTokenOwnQueryOneSchema
    ...
    export const AccessTokenPermissionQueryOneSchema = z.object({ 
...
export type  AccessTokenOwnProjection = z.infer<typeof AccessTokenOwnProjectionSchema>; 
...
export type  AccessTokenOwnQueryOne = z.infer<typeof AccessTokenOwnQueryOneSchema>; 
...
export type  OperationOwnProjection = z.infer<typeof OperationOwnProjectionSchema>; 
...
export type  PermissionOwnProjection = z.infer<typeof PermissionOwnProjectionSchema>; 
...
export type  RolePermissionOwnProjection = z.infer<typeof RolePermissionOwnProjectionSchema>; 

export type  RolePermissionOwnWhere = z.infer<typeof RolePermissionOwnWhereSchema>; 

export type  RolePermissionOwnQuery = z.infer<typeof RolePermissionOwnQuerySchema>; 

export type  RolePermissionOwnQueryOne = z.infer<typeof RolePermissionOwnQueryOneSchema>; 

export type  RolePermissionWhere = z.infer<typeof RolePermissionWhereSchema>; 

export type  RolePermissionQueryOne = z.infer<typeof RolePermissionQueryOneSchema>; 

export type  RolePermissionQuery = z.infer<typeof RolePermissionQuerySchema>; 

export type  RolePermissionProjection = z.infer<typeof RolePermissionProjectionSchema>; 
...
export type  ActivityLogOwnProjection = z.infer<typeof ActivityLogOwnProjectionSchema>; 
...
export type  ActivityLogOwnQueryOne = z.infer<typeof ActivityLogOwnQueryOneSchema>; 
...
export type  UserPermissionOwnProjection = z.infer<typeof UserPermissionOwnProjectionSchema>; 

export type  UserPermissionOwnWhere = z.infer<typeof UserPermissionOwnWhereSchema>; 

export type  UserPermissionOwnQuery = z.infer<typeof UserPermissionOwnQuerySchema>; 

export type  UserPermissionOwnQueryOne = z.infer<typeof UserPermissionOwnQueryOneSchema>; 

export type  UserPermissionWhere = z.infer<typeof UserPermissionWhereSchema>; 

export type  UserPermissionQueryOne = z.infer<typeof UserPermissionQueryOneSchema>; 

export type  UserPermissionQuery = z.infer<typeof UserPermissionQuerySchema>; 

export type  UserPermissionProjection = z.infer<typeof UserPermissionProjectionSchema>; 
...
export type  AccessTokenPermissionOrderBy = z.infer<typeof AccessTokenPermissionOrderBySchema>; 

export type  AccessTokenPermissionOwnProjection = z.infer<typeof AccessTokenPermissionOwnProjectionSchema>; 

export type  AccessTokenPermissionOwnWhere = z.infer<typeof AccessTokenPermissionOwnWhereSchema>; 

export type  AccessTokenPermissionOwnQuery = z.infer<typeof AccessTokenPermissionOwnQuerySchema>; 

export type  AccessTokenPermissionOwnQueryOne = z.infer<typeof AccessTokenPermissionOwnQueryOneSchema>; 

export type  AccessTokenPermissionWhere = z.infer<typeof AccessTokenPermissionWhereSchema>; 

export type  AccessTokenPermissionQueryOne = z.infer<typeof AccessTokenPermissionQueryOneSchema>; 

export type  AccessTokenPermissionQuery = z.infer<typeof AccessTokenPermissionQuerySchema>; 

export type  AccessTokenPermissionProjection = z.infer<typeof AccessTokenPermissionProjectionSchema>; 

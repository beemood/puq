...
-- CreateIndex
CREATE UNIQUE INDEX "Address_contactId_order_key" ON "public"."Address"("contactId", "order");

-- CreateIndex
CREATE UNIQUE INDEX "Email_contactId_order_key" ON "public"."Email"("contactId", "order");

-- CreateIndex
CREATE UNIQUE INDEX "Email_contactId_email_key" ON "public"."Email"("contactId", "email");

-- CreateIndex
CREATE UNIQUE INDEX "Phone_contactId_order_key" ON "public"."Phone"("contactId", "order");

-- CreateIndex
CREATE UNIQUE INDEX "Phone_contactId_phone_key" ON "public"."Phone"("contactId", "phone");

-- CreateIndex
CREATE UNIQUE INDEX "Website_contactId_order_key" ON "public"."Website"("contactId", "order");

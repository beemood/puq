...
import * as P from '@puq/zod';
   ...
   */
export const EmployeeField = z.enum([ 'id', 'createdAt', 'updatedAt', 'deletedAt', 'updatedBy', 'readonly', 'active', 'employeeId' ])
...
export type CategoryFieldType = z.infer<typeof CategoryField>; 
  ...
  /**
   * CurrencyField schema (Thu Nov 13 2025)
   */
...
export type ProductTagFieldType = z.infer<typeof ProductTagField>; 
  ...
  /**
   * SupplierField schema (Thu Nov 13 2025)
   */
...
export type ProductFieldType = z.infer<typeof ProductField>; 
  ...
  /**
   * ImageField schema (Thu Nov 13 2025)
   */
...
export type ImageFieldType = z.infer<typeof ImageField>; 
  ...
  /**
   * ProductImageField schema (Thu Nov 13 2025)
   */
...
export type ProductImageFieldType = z.infer<typeof ProductImageField>; 
  ...
  /**
   * PriceLevelField schema (Thu Nov 13 2025)
   */
...
export type SerialNumberFieldType = z.infer<typeof SerialNumberField>; 
   ...
   */
export const EmployeeOmit = z.object({ id: P.bool, createdAt: P.bool, updatedAt: P.bool, deletedAt: P.bool, updatedBy: P.bool, readonly: P.bool, active: P.bool, employeeId: P.bool }).partial()
...
export type CategoryOmitType = z.infer<typeof CategoryOmit>; 
  ...
  /**
   * CurrencyOmit schema (Thu Nov 13 2025)
   */
...
export type ProductTagOmitType = z.infer<typeof ProductTagOmit>; 
  ...
  /**
   * SupplierOmit schema (Thu Nov 13 2025)
   */
...
export type ProductOmitType = z.infer<typeof ProductOmit>; 
  ...
  /**
   * ImageOmit schema (Thu Nov 13 2025)
   */
...
export type ImageOmitType = z.infer<typeof ImageOmit>; 
  ...
  /**
   * ProductImageOmit schema (Thu Nov 13 2025)
   */
...
export type ProductImageOmitType = z.infer<typeof ProductImageOmit>; 
  ...
  /**
   * PriceLevelOmit schema (Thu Nov 13 2025)
   */
...
export type CategorySelectOwnType = z.infer<typeof CategorySelectOwn>; 
  ...
  /**
   * CurrencySelectOwn schema (Thu Nov 13 2025)
   */
...
export type ProductTagSelectOwnType = z.infer<typeof ProductTagSelectOwn>; 
  ...
  /**
   * SupplierSelectOwn schema (Thu Nov 13 2025)
   */
...
export type ProductImageSelectOwnType = z.infer<typeof ProductImageSelectOwn>; 
  ...
  /**
   * PriceLevelSelectOwn schema (Thu Nov 13 2025)
   */
...
export type SerialNumberSelectOwnType = z.infer<typeof SerialNumberSelectOwn>; 
   ...
   */
export const EmployeeInclude = z.object({ employee: z.object({ select :EmployeeSelectOwn }).or(P.bool), changedStores: z.object({ select :StoreSelectOwn }).or(P.bool), changedCategories: z.object({ select :CategorySelectOwn }).or(P.bool), changedTags: z.object({ select :TagSelectOwn }).or(P.bool), changedProductTags: z.object({ select :ProductTagSelectOwn }).or(P.bool), changedSuppliers: z.object({ select :SupplierSelectOwn }).or(P.bool), changedProducts: z.object({ select :ProductSelectOwn }).or(P.bool), changedPriceLevels: z.object({ select :PriceLevelSelectOwn }).or(P.bool), changedPrices: z.object({ select :PriceSelectOwn }).or(P.bool), changedQuantitys: z.object({ select :QuantitySelectOwn }).or(P.bool), changedSerialNumbers: z.object({ select :SerialNumberSelectOwn }).or(P.bool), chagnedImages: z.object({ select :ImageSelectOwn }).or(P.bool), chagnedProductImages: z.object({ select :ProductImageSelectOwn }).or(P.bool), changedCurrencies: z.object({ select :CurrencySelectOwn }).or(P.bool), changedEmployees: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type EmployeeIncludeType = z.infer<typeof EmployeeInclude>; 

  /**
   * StoreInclude schema (Thu Nov 13 2025)
   */
export const StoreInclude = z.object({ quantities: z.object({ select :QuantitySelectOwn }).or(P.bool), serialNumbers: z.object({ select :SerialNumberSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type StoreIncludeType = z.infer<typeof StoreInclude>; 

  /**
   * CategoryInclude schema (Thu Nov 13 2025)
   */
export const CategoryInclude = z.object({ parent: z.object({ select :CategorySelectOwn }).or(P.bool), children: z.object({ select :CategorySelectOwn }).or(P.bool), products: z.object({ select :ProductSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type CategoryIncludeType = z.infer<typeof CategoryInclude>; 

  /**
   * CurrencyInclude schema (Thu Nov 13 2025)
   */
export const CurrencyInclude = z.object({ employee: z.object({ select :EmployeeSelectOwn }).or(P.bool), priceLevels: z.object({ select :PriceLevelSelectOwn }).or(P.bool) }).partial()
export type CurrencyIncludeType = z.infer<typeof CurrencyInclude>; 

  /**
   * TagInclude schema (Thu Nov 13 2025)
   */
export const TagInclude = z.object({ productTags: z.object({ select :ProductTagSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type TagIncludeType = z.infer<typeof TagInclude>; 

  /**
   * ProductTagInclude schema (Thu Nov 13 2025)
   */
export const ProductTagInclude = z.object({ product: z.object({ select :ProductSelectOwn }).or(P.bool), tag: z.object({ select :TagSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type ProductTagIncludeType = z.infer<typeof ProductTagInclude>; 

  /**
   * SupplierInclude schema (Thu Nov 13 2025)
   */
export const SupplierInclude = z.object({ products: z.object({ select :ProductSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type SupplierIncludeType = z.infer<typeof SupplierInclude>; 

  /**
   * ProductInclude schema (Thu Nov 13 2025)
   */
export const ProductInclude = z.object({ parent: z.object({ select :ProductSelectOwn }).or(P.bool), variants: z.object({ select :ProductSelectOwn }).or(P.bool), category: z.object({ select :CategorySelectOwn }).or(P.bool), supplier: z.object({ select :SupplierSelectOwn }).or(P.bool), productTags: z.object({ select :ProductTagSelectOwn }).or(P.bool), prices: z.object({ select :PriceSelectOwn }).or(P.bool), quantities: z.object({ select :QuantitySelectOwn }).or(P.bool), serialNumbers: z.object({ select :SerialNumberSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool), productImages: z.object({ select :ProductImageSelectOwn }).or(P.bool) }).partial()
export type ProductIncludeType = z.infer<typeof ProductInclude>; 

  /**
   * ImageInclude schema (Thu Nov 13 2025)
   */
export const ImageInclude = z.object({ employee: z.object({ select :EmployeeSelectOwn }).or(P.bool), productImages: z.object({ select :ProductImageSelectOwn }).or(P.bool) }).partial()
export type ImageIncludeType = z.infer<typeof ImageInclude>; 

  /**
   * ProductImageInclude schema (Thu Nov 13 2025)
   */
export const ProductImageInclude = z.object({ product: z.object({ select :ProductSelectOwn }).or(P.bool), image: z.object({ select :ImageSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type ProductImageIncludeType = z.infer<typeof ProductImageInclude>; 

  /**
   * PriceLevelInclude schema (Thu Nov 13 2025)
   */
export const PriceLevelInclude = z.object({ prices: z.object({ select :PriceSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool), currency: z.object({ select :CurrencySelectOwn }).or(P.bool) }).partial()
export type PriceLevelIncludeType = z.infer<typeof PriceLevelInclude>; 

  /**
   * PriceInclude schema (Thu Nov 13 2025)
   */
export const PriceInclude = z.object({ product: z.object({ select :ProductSelectOwn }).or(P.bool), priceLevel: z.object({ select :PriceLevelSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type PriceIncludeType = z.infer<typeof PriceInclude>; 

  /**
   * QuantityInclude schema (Thu Nov 13 2025)
   */
export const QuantityInclude = z.object({ product: z.object({ select :ProductSelectOwn }).or(P.bool), store: z.object({ select :StoreSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
export type QuantityIncludeType = z.infer<typeof QuantityInclude>; 

  /**
   * SerialNumberInclude schema (Thu Nov 13 2025)
   */
export const SerialNumberInclude = z.object({ product: z.object({ select :ProductSelectOwn }).or(P.bool), store: z.object({ select :StoreSelectOwn }).or(P.bool), employee: z.object({ select :EmployeeSelectOwn }).or(P.bool) }).partial()
...
export const EmployeeOrderByOwn = z.object({ 
    id: P.dir, createdAt: P.dir, updatedAt: P.dir, deletedAt: P.dir, updatedBy: P.dir, readonly: P.dir, active: P.dir, employeeId: P.dir 
  }).partial()
...
export type CategoryOrderByOwnType = z.infer<typeof CategoryOrderByOwn>; 
  ...
  /**
   * CurrencyOrderByOwn schema (Thu Nov 13 2025)
   */
...
export type ProductTagOrderByOwnType = z.infer<typeof ProductTagOrderByOwn>; 
  ...
  /**
   * SupplierOrderByOwn schema (Thu Nov 13 2025)
   */
...
export type ProductOrderByOwnType = z.infer<typeof ProductOrderByOwn>; 
  ...
  /**
   * ImageOrderByOwn schema (Thu Nov 13 2025)
   */
...
export type ImageOrderByOwnType = z.infer<typeof ImageOrderByOwn>; 
  ...
  /**
   * ProductImageOrderByOwn schema (Thu Nov 13 2025)
   */
...
export type ProductImageOrderByOwnType = z.infer<typeof ProductImageOrderByOwn>; 
  ...
  /**
   * PriceLevelOrderByOwn schema (Thu Nov 13 2025)
   */
...
export type CategoryOrderByType = z.infer<typeof CategoryOrderBy>; 
  ...
  /**
   * CurrencyOrderBy schema (Thu Nov 13 2025)
   */
...
export type ProductTagOrderByType = z.infer<typeof ProductTagOrderBy>; 
  ...
  /**
   * SupplierOrderBy schema (Thu Nov 13 2025)
   */
...
export type ProductOrderByType = z.infer<typeof ProductOrderBy>; 
  ...
  /**
   * ImageOrderBy schema (Thu Nov 13 2025)
   */
...
export type ImageOrderByType = z.infer<typeof ImageOrderBy>; 
  ...
  /**
   * ProductImageOrderBy schema (Thu Nov 13 2025)
   */
...
export type ProductImageOrderByType = z.infer<typeof ProductImageOrderBy>; 
  ...
  /**
   * PriceLevelOrderBy schema (Thu Nov 13 2025)
   */
...
export type SerialNumberOrderByType = z.infer<typeof SerialNumberOrderBy>; 
   ...
   */
export const EmployeeWhereOwn = z.object({ id: P.intFilter, createdAt: P.datetimeFilter, updatedAt: P.datetimeFilter, deletedAt: P.datetimeFilter, updatedBy: P.intFilter, readonly: P.boolFilter, active: P.boolFilter, employeeId: P.strFilter }).partial()
...
export type CategoryWhereOwnType = z.infer<typeof CategoryWhereOwn>; 
  ...
  /**
   * CurrencyWhereOwn schema (Thu Nov 13 2025)
   */
...
export type ProductTagWhereOwnType = z.infer<typeof ProductTagWhereOwn>; 
  ...
  /**
   * SupplierWhereOwn schema (Thu Nov 13 2025)
   */
...
export type ProductWhereOwnType = z.infer<typeof ProductWhereOwn>; 
  ...
  /**
   * ImageWhereOwn schema (Thu Nov 13 2025)
   */
...
export type ImageWhereOwnType = z.infer<typeof ImageWhereOwn>; 
  ...
  /**
   * ProductImageWhereOwn schema (Thu Nov 13 2025)
   */
...
export type ProductImageWhereOwnType = z.infer<typeof ProductImageWhereOwn>; 
  ...
  /**
   * PriceLevelWhereOwn schema (Thu Nov 13 2025)
   */
...
export type CategoryWhereType = z.infer<typeof CategoryWhere>; 
  ...
  /**
   * CurrencyWhere schema (Thu Nov 13 2025)
   */
...
export type ProductTagWhereType = z.infer<typeof ProductTagWhere>; 
  ...
  /**
   * SupplierWhere schema (Thu Nov 13 2025)
   */
...
export type ProductWhereType = z.infer<typeof ProductWhere>; 
  ...
  /**
   * ImageWhere schema (Thu Nov 13 2025)
   */
...
export type ImageWhereType = z.infer<typeof ImageWhere>; 
  ...
  /**
   * ProductImageWhere schema (Thu Nov 13 2025)
   */
...
export type ProductImageWhereType = z.infer<typeof ProductImageWhere>; 
  ...
  /**
   * PriceLevelWhere schema (Thu Nov 13 2025)
   */
...
export type CategoryQueryOwnType = z.infer<typeof CategoryQueryOwn>; 
  ...
  /**
   * CurrencyQueryOwn schema (Thu Nov 13 2025)
   */
...
export type ProductTagQueryOwnType = z.infer<typeof ProductTagQueryOwn>; 
  ...
  /**
   * SupplierQueryOwn schema (Thu Nov 13 2025)
   */
...
export type ProductQueryOwnType = z.infer<typeof ProductQueryOwn>; 
  ...
  /**
   * ImageQueryOwn schema (Thu Nov 13 2025)
   */
...
export type ImageQueryOwnType = z.infer<typeof ImageQueryOwn>; 
  ...
  /**
   * ProductImageQueryOwn schema (Thu Nov 13 2025)
   */
...
export type ProductImageQueryOwnType = z.infer<typeof ProductImageQueryOwn>; 
  ...
  /**
   * PriceLevelQueryOwn schema (Thu Nov 13 2025)
   */
...
export type CategoryQueryOneType = z.infer<typeof CategoryQueryOne>; 
  ...
  /**
   * CurrencyQueryOne schema (Thu Nov 13 2025)
   */
...
export type ProductTagQueryOneType = z.infer<typeof ProductTagQueryOne>; 
  ...
  /**
   * SupplierQueryOne schema (Thu Nov 13 2025)
   */
...
export type ProductQueryOneType = z.infer<typeof ProductQueryOne>; 
  ...
  /**
   * ImageQueryOne schema (Thu Nov 13 2025)
   */
...
export type ImageQueryOneType = z.infer<typeof ImageQueryOne>; 
  ...
  /**
   * ProductImageQueryOne schema (Thu Nov 13 2025)
   */
...
export type ProductImageQueryOneType = z.infer<typeof ProductImageQueryOne>; 
  ...
  /**
   * PriceLevelQueryOne schema (Thu Nov 13 2025)
   */
...
export type CategoryQueryType = z.infer<typeof CategoryQuery>; 
  ...
  /**
   * CurrencyQuery schema (Thu Nov 13 2025)
   */
...
export type ProductTagQueryType = z.infer<typeof ProductTagQuery>; 
  ...
  /**
   * SupplierQuery schema (Thu Nov 13 2025)
   */
...
export type ProductQueryType = z.infer<typeof ProductQuery>; 
  ...
  /**
   * ImageQuery schema (Thu Nov 13 2025)
   */
...
export type ImageQueryType = z.infer<typeof ImageQuery>; 
  ...
  /**
   * ProductImageQuery schema (Thu Nov 13 2025)
   */
...
export type ProductImageQueryType = z.infer<typeof ProductImageQuery>; 
  ...
  /**
   * PriceLevelQuery schema (Thu Nov 13 2025)
   */
...
export type CategorySelectType = z.infer<typeof CategorySelect>; 
  ...
  /**
   * CurrencySelect schema (Thu Nov 13 2025)
   */
...
export type ProductTagSelectType = z.infer<typeof ProductTagSelect>; 
  ...
  /**
   * SupplierSelect schema (Thu Nov 13 2025)
   */
...
export type ProductImageSelectType = z.infer<typeof ProductImageSelect>; 
  ...
  /**
   * PriceLevelSelect schema (Thu Nov 13 2025)
   */
...
export type CategoryProjectionType = z.infer<typeof CategoryProjection>; 
  ...
  /**
   * CurrencyProjection schema (Thu Nov 13 2025)
   */
...
export type ProductTagProjectionType = z.infer<typeof ProductTagProjection>; 
  ...
  /**
   * SupplierProjection schema (Thu Nov 13 2025)
   */
...
export type ProductProjectionType = z.infer<typeof ProductProjection>; 
  ...
  /**
   * ImageProjection schema (Thu Nov 13 2025)
   */
...
export type ImageProjectionType = z.infer<typeof ImageProjection>; 
  ...
  /**
   * ProductImageProjection schema (Thu Nov 13 2025)
   */
...
export type ProductImageProjectionType = z.infer<typeof ProductImageProjection>; 
  ...
  /**
   * PriceLevelProjection schema (Thu Nov 13 2025)
   */
...
export type SerialNumberProjectionType = z.infer<typeof SerialNumberProjection>; 
   ...
   */
export const EmployeeCreateOwn = z.object({ readonly: P.bool.optional(),active: P.bool.optional(),employeeId: P.str })
...
export type CategoryCreateOwnType = z.infer<typeof CategoryCreateOwn>; 
  ...
  /**
   * CurrencyCreateOwn schema (Thu Nov 13 2025)
   */
...
export type ProductTagCreateOwnType = z.infer<typeof ProductTagCreateOwn>; 
  ...
  /**
   * SupplierCreateOwn schema (Thu Nov 13 2025)
   */
...
export type ProductCreateOwnType = z.infer<typeof ProductCreateOwn>; 
  ...
  /**
   * ImageCreateOwn schema (Thu Nov 13 2025)
   */
...
export type ImageCreateOwnType = z.infer<typeof ImageCreateOwn>; 
  ...
  /**
   * ProductImageCreateOwn schema (Thu Nov 13 2025)
   */
...
export type ProductImageCreateOwnType = z.infer<typeof ProductImageCreateOwn>; 
  ...
  /**
   * PriceLevelCreateOwn schema (Thu Nov 13 2025)
   */
...
export type CategoryUpdateType = z.infer<typeof CategoryUpdate>; 
  ...
  /**
   * CurrencyCreate schema (Thu Nov 13 2025)
   */
...
export type CurrencyCreateType = z.infer<typeof CurrencyCreate>; 
  ...
  /**
   * CurrencyUpdate schema (Thu Nov 13 2025)
   */
...
export type ProductTagUpdateType = z.infer<typeof ProductTagUpdate>; 
  ...
  /**
   * SupplierCreate schema (Thu Nov 13 2025)
   */
...
export type SupplierCreateType = z.infer<typeof SupplierCreate>; 
  ...
  /**
   * SupplierUpdate schema (Thu Nov 13 2025)
   */
...
export type ProductUpdateType = z.infer<typeof ProductUpdate>; 
  ...
  /**
   * ImageCreate schema (Thu Nov 13 2025)
   */
...
export type ProductImageCreateType = z.infer<typeof ProductImageCreate>; 
  ...
  /**
   * ProductImageUpdate schema (Thu Nov 13 2025)
   */
...
export type ProductImageUpdateType = z.infer<typeof ProductImageUpdate>; 
  ...
  /**
   * PriceLevelCreate schema (Thu Nov 13 2025)
   */
...
export type PriceLevelCreateType = z.infer<typeof PriceLevelCreate>; 
  ...
  /**
   * PriceLevelUpdate schema (Thu Nov 13 2025)
   */

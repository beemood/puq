-- CreateEnum
CREATE TYPE "public"."DiscountTargetType" AS ENUM ('STORE', 'PRICE_LEVEL', 'CATEGORY', 'PRODUCT', 'VARIANT', 'STORE_CATEGORY', 'STORE_PRODUCT', 'STORE_VARIANT', 'PRICE_LEVEL_CATEGORY', 'PRICE_LEVEL_PRODUCT', 'PRICE_LEVEL_VARIANT');

-- CreateEnum
CREATE TYPE "public"."ValueType" AS ENUM ('PERCENT', 'FIXED');

-- CreateEnum
CREATE TYPE "public"."DiscountType" AS ENUM ('SIMPLE', 'VOLUME', 'FREE_SHIPPING', 'ORDER_TOTAL');

-- CreateEnum
CREATE TYPE "public"."TimeUnit" AS ENUM ('SECOND', 'MINUTE', 'HOUR', 'DAY', 'MONTH', 'YEAR', 'DECADE', 'LIFE_TIME');
...
CREATE TABLE "public"."DiscountTarget" (
    "id" SERIAL NOT NULL,
    "type" "public"."DiscountTargetType" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "AttributeUnit_attributeId_unitId_key" ON "public"."AttributeUnit"("attributeId", "unitId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Price_variantId_priceLevelId_key" ON "public"."Price"("variantId", "priceLevelId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SerialNumber_variantId_storeId_key" ON "public"."SerialNumber"("variantId", "storeId");

-- CreateIndex
CREATE UNIQUE INDEX "Discount_code_key" ON "public"."Discount"("code");

-- CreateIndex
CREATE UNIQUE INDEX "DiscountTarget_discountId_storeId_priceLevelId_categoryId_p_key" ON "public"."DiscountTarget"("discountId", "storeId", "priceLevelId", "categoryId", "productId", "variantId");

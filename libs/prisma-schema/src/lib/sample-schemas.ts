...
export const SampleUpdateSchema = z.object({
  ...
  deletedAt: _date.optional(),
  categoryId: _id.optional(),
  name: _name.optional(),
  slug: _slug.optional(),
  description: _description.optional(),
  active: _bool.optional(),
  notes: _str.array().optional(),
...
export type SampleTagCompleteSelect = z.infer<
  typeof SampleTagCompleteSelectSchema
>;
...
export type SampleCompleteQueryOne = z.infer<
  typeof SampleCompleteQueryOneSchema
>;

export type SampleTagCompleteQueryOne = z.infer<
  typeof SampleTagCompleteQueryOneSchema
>;
...
export type SampleTagCompleteQuery = z.infer<
  typeof SampleTagCompleteQuerySchema
>;

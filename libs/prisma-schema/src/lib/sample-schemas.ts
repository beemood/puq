...
export const CategoryQuerySchema = z.object({take: _take,skip: _skip,distinct: CategoryDistinctSchema.optional(),select: CategoryOwnSelectSchemaJson.optional(),omit: CategoryOmitSchemaJson.optional(),include: CategoryIncludeSchemaJson.optional(),where: CategoryOwnWhereSchemaJson.optional(),orderBy: CategoryOwnOrderBySchemaJson.optional()})

export const TagQuerySchema = z.object({take: _take,skip: _skip,distinct: TagDistinctSchema.optional(),select: TagOwnSelectSchemaJson.optional(),omit: TagOmitSchemaJson.optional(),include: TagIncludeSchemaJson.optional(),where: TagOwnWhereSchemaJson.optional(),orderBy: TagOwnOrderBySchemaJson.optional()})

export const SampleQuerySchema = z.object({take: _take,skip: _skip,distinct: SampleDistinctSchema.optional(),select: SampleOwnSelectSchemaJson.optional(),omit: SampleOmitSchemaJson.optional(),include: SampleIncludeSchemaJson.optional(),where: SampleOwnWhereSchemaJson.optional(),orderBy: SampleOwnOrderBySchemaJson.optional()})

export const SampleTagQuerySchema = z.object({take: _take,skip: _skip,distinct: SampleTagDistinctSchema.optional(),select: SampleTagOwnSelectSchemaJson.optional(),omit: SampleTagOmitSchemaJson.optional(),include: SampleTagIncludeSchemaJson.optional(),where: SampleTagOwnWhereSchemaJson.optional(),orderBy: SampleTagOwnOrderBySchemaJson.optional()})

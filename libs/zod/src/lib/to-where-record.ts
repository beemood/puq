...
import { z } from 'zod';
import { BooleanFilterSchema, DateFilterSchema, IntegerFilterSchema, NumberFilterSchema, StringFilterSchema } from './property-filter-schemas.js';
 ...
 */
export function toWhereRecord<T extends Record<string, z.ZodType>>(zodObject: z.ZodObject<T>) {

    const newShape = Object.fromEntries(
        Object.entries(zodObject.shape).map(([key, value]) => {
